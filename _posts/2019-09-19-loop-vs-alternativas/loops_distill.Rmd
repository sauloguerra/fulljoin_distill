...
Neste caso, o custo de distribuição da tarefa entre os *cores* (*workers*) é maior do que o ganho
de tempo por dividir a tarefa entre eles. Vamos apresentar em outro post o processo de paralelização de forma mais detalhada e incluir exemplos nos quais a paralelização apresenta
ganhos significativos de desempenho. De todo modo, o objetivo deste post foi alcançado: mostramos
que existem alternativas ao loop que trazem um relevante aumento de performance.