...
print(dados_base %>% mutate(D = sum(A, B, C)) %>% head())
...
print(dados_base %>% mutate(D = A + B + C) %>% head())
...
print(head(dados_base_futureapply))
print(futureapply_time)
