...
description: |
  A partir de um simples exemplo, vamos testar o desempenho de loops comparando-o com os de outras possíveis alternativas.
...
o loop foi a alternativa de pior desempenho (ver gráfico abaixo). 

```{r}

library(ggplot2)

df_grafico <- data.frame(abordagem = c("loop", "foreach", 
                                       "apply", "future.apply", 
                                       "pmap", "future_pmap"),
...
ggplot(df_grafico, aes(x=abordagem_factor, y=tempo, label=tempo)) +
  geom_point(stat='identity', color=c("#619CFF"), size=9, alpha = 0.7)  +
  geom_segment(aes(y = 0, 
               ...
               alpha = 0.6,
               size = 1) +
  geom_text(color="#333333", size=2.8, fontface = "bold") +
