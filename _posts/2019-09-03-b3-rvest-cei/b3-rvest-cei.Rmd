...
# key_set('cpf', username = 'saulo', keyring = 'cei-b3')
# key_set('senha', username = 'saulo', keyring = 'cei-b3')
...
A página com os dados que queremos raspar se chama Negociação de Ativos. Ao acessar, repare na URL, é ela que 

![Menu](../../images/cei_menu.png){ width=75 }
...
glimpse(dados_totais %>% select(-`Valor Total(R$)`, -Quantidade))
```
