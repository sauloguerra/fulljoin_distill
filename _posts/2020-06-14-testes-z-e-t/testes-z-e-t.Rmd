...
O *teste t* mostra que é possível rejeitar a hipótese nula aos nível de significância de 5%. Em outras palavras, temos evidências de que o novo método tem impactos positivos sobre o salário inicial dos economistas.
...
O nosso teste indica que a hipótese nula pode ser rejeitada a um nível de significância de 5%. Em outras palavras, há evidências de que adiferença entre a média de altura das duas regiões não é estatisticamente igual a zero.
