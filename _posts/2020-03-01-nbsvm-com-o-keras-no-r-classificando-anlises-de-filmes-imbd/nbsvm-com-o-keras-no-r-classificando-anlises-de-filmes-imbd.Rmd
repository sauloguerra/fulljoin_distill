...
O código abaixo cria o nosso vocabulário. Isto é, o conjunto de termos que serão considerados pelo modelo. As stopwords não foram removidas (de propósito) e consideramos unigragramas, bigramas e trigramas. O vocabulário foi limitado a 800.000 termos.
